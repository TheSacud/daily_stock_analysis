...
// Keep same-origin API by default so production/static deployments do not accidentally send failed requests to user-local localhost.
// Override the default only when VITE_API_URL is explicitly provided.
