...
_THINKING_TOOL_LABELS: Dict[str, str] = {
    ...
    "analyze_trend": "technical indicatorsanalyze",
    "get_chip_distribution": "chip distributionanalyze",
    "search_stock_news": "newssearch",
    "search_comprehensive_intel": "\u7efc\u5408\u60c5\u62a5search",
    "get_market_indices": "market\u6982\u89c8\u83b7\u53d6",
    "get_sector_rankings": "industrysectoranalyze",
    "get_analysis_context": "historyanalyze\u4e0a\u4e0b\u6587",
    "get_stock_info": "\u57fa\u672cinfo\u83b7\u53d6",
    "analyze_pattern": "K\u7ebf\u5f62\u6001\u8bc6\u522b",
    "get_volume_analysis": "\u91cf\u80fdanalyze",
    "calculate_ma": "\u5747\u7ebf\u8ba1\u7b97",
    "get_skill_backtest_summary": "\u6280\u80fdbacktest\u6982\u89c8",
    "get_strategy_backtest_summary": "strategybacktest\u6982\u89c8",
    "get_stock_backtest_summary": "individual stocksbacktest\u6570\u636e",
}
    ...
    *,
    ...
    for step in range(max_steps):
        ...
        if response.tool_calls:
            ...
            if progress_callback:
                progress_callback(stream_event("generating", step=step + 1, message="\u6b63\u5728\u751f\u6210\u6700\u7ec8analyze..."))
