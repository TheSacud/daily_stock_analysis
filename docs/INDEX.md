...
| --- | --- | --- |
| Understand what the project does | [README](../README.md) | [Full Guide](full-guide.md) |
| Run the project for the first time | [README](../README.md) | [Full Guide](full-guide.md) |
| Configure model providers | [LLM Config Guide (EN)](LLM_CONFIG_GUIDE.md) | [Provider Configuration Guide](llm-providers.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) |
| Configure notifications | [Notification Baseline](notifications.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | [Full Guide (EN)](full-guide.md) |
| Deploy to a server or cloud platform | [Deploy Guide (EN)](DEPLOY.md) | [Cloud WebUI Deployment](deploy-webui-cloud.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only), [Zeabur Deployment](docker/zeabur-deployment.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) |
...
| Document | Contents |
| --- | --- |
| [README](../README.md) | Project overview, key features, quick start, sample output |
| [Full Guide (EN)](full-guide.md) | Environment setup, run modes, configuration, deployment paths, and common issues |
| [FAQ (EN)](FAQ.md) | Common configuration, model, notification, deployment, and runtime issues |
...
| Document | Contents |
| --- | --- |
| [LLM Config Guide (EN)](LLM_CONFIG_GUIDE.md) | Model providers, three-tier configuration, Web settings, and common model setup |
...
| Document | Contents |
| --- | --- |
| [Bot Commands (EN)](bot-command.md) | Bot commands, webhooks, platform integration, and callback behavior |
...
| Document | Contents |
| --- | --- |
| [Deploy Guide (EN)](DEPLOY.md) | Server deployment, Docker, systemd, Supervisor, and related options |
...
| [Security And Rollback Review](security-review.md) | Read-only guardrail review for rollback, permissions, secret handling, deploy approval, and follow-up cards |
...
| Document | Contents |
| --- | --- |
| [English Documentation Index](INDEX.md) | English documentation entry point |
| [README copy](README_CHT.md) | English project overview and quick start copy retained for old links |
