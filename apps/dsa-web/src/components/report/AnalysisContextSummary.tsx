...
const TEXT = {
  zh: {
    ...
    title: 'Input Data Blocks',
    counts: 'Status Counts',
    source: 'Source',
    warnings: 'Warnings',
    missingReasons: 'Missing Reasons',
    inputScope: 'Current Analysis Input',
    evidenceScope: 'Only represents the inputs sent to this LLM run; it does not prove the data source succeeded',
    qualityScore: 'Quality Score',
    limitations: 'Data Limitations',
    newsResultCount: 'News Result Count',
...
const MISSING_REASON_LABELS: Record<ReportLanguage, Record<string, string>> = {
  zh: {
    ...
    today_missing: 'Today data was not included in analysis input',
    yesterday_missing: 'Yesterday data was not included in analysis input',
  },
  en: {
    daily_bars_missing: 'Not included in analysis input',
    news_context_missing: 'Not included in analysis input',
