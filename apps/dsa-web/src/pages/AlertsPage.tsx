  ...
  return (
    <AppPage className="space-y-5">
      <PageHeader
        ...
        title="Alert Center"
        description="Manage event alerts, daily technical indicators, watchlist rules, portfolio/account integrations, and market traffic light rules. Run one-off tests and review trigger history from background evaluation tasks."
      />
      ...
      <Card title="Notification Attempts" subtitle="Notification Results" variant="bordered" padding="md">
        ...
        {!notificationsLoading && notifications.length === 0 ? (
          <EmptyState
            ...
            description="There are no notification attempt details to show yet. Triggered alerts will still be sent through the configured notification channels."
          />
        ) : null}
        {!notificationsLoading && notifications.length > 0 ? (
