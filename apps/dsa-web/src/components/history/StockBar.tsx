...
/**
 * Stock bar component: shows historical analysis records by stock, one item per stock.
 * Market reviews can appear as MARKET items and are sorted by most recent analysis time.
 */
