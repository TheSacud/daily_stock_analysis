...
const MARKET_BADGE_CONFIG = {
  ...
  HK: { label: 'HK Stocks', className: 'border-success/25 bg-success/10 text-success' },
  US: { label: 'US Stocks', className: 'border-cyan/25 bg-cyan/10 text-cyan' },
  JP: { label: 'JP Stocks', className: 'border-indigo-500/25 bg-indigo-500/10 text-indigo-500' },
  KR: { label: 'KR Stocks', className: 'border-rose-500/25 bg-rose-500/10 text-rose-500' },
