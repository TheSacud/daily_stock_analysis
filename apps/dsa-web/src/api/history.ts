...
export const historyApi = {
  /**
   * Fetch historical analysis list
  ...
  /**
   * Fetch historical report details
   * @param recordId Analysis history primary key ID. Use ID instead of query_id because query_id can repeat in batch analysis.
   */
  ...
  /**
   * Fetch news linked to a historical report
   * @param recordId Analysis history primary key ID
  ...
  /**
   * Fetch historical report content in Markdown format
   * @param recordId Analysis history primary key ID
   * @returns Complete report content in Markdown format
   */
  ...
  /**
   * Fetch run diagnostics summary for a historical report
   * @param recordId Analysis history primary key ID
   */
  ...
  /**
   * Fetch run-flow snapshot for a historical report
   * @param recordId Analysis history primary key ID
   */
  ...
  /**
   * Delete historical records in bulk
   * @param recordIds Analysis history primary key ID list
   */
  ...
  /**
   * Delete all historical records for a stock code
  ...
  /**
   * Fetch the stock sidebar list. Deduplicates stocks and excludes market reviews.
   */
